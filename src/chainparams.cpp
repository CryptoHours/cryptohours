...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Ivan Helmot PIVX Fork!";
        ...
        //     genesis.nTime = j;
        //     for (int i=0; i<112402015; i++) {
        //         genesis.nNonce = i; //2402015;
        //         if (MyCheckProofOfWork(genesis.GetHash(), genesis.nBits)) {
        //             printf("nNonce found %d %d\n", genesis.nNonce, genesis.nTime);
        //             hashGenesisBlock = genesis.GetHash();
        //             printf("%s hashGenesisBlock\n", hashGenesisBlock.ToString().c_str());
        //             printf("%s genesis.hashMerkleRoot\n", genesis.hashMerkleRoot.ToString().c_str());
        //             break;
        //         }
        //     }
        // }
        // printf("nNonce not found!\n");
        ...
        nStopDualSporkKeys = 1508803199; // Oct 23 2017 11:59:59 GMT
