                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CryptoHours Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptohours: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CryptoHours Core"), this);
    aboutAction->setStatusTip(tr("Show information about CryptoHours Core"));
    ...
    openAction->setStatusTip(tr("Open a cryptohours: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CryptoHours Core help message to get a list with possible PIVX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CryptoHours Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("CryptoHours Core"); // default title
