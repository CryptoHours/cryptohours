...
void PrivacyDialog::on_pushButtonMintzPIV_clicked()
{
    ...
    ui->TEMintStatus->setPlainText(tr("Minting ") + ui->labelMintAmountValue->text() + " zCH...");
    ...
    QString strStatsHeader = tr("Successfully minted ") + ui->labelMintAmountValue->text() + tr(" zCH in ") + 
...
void PrivacyDialog::sendzPIV()
{
    ...
    QString strAmount = "<b>" + QString::number(dAmount, 'f', 8) + " zCH</b>";
    ...
    for (CZerocoinSpend spend : receipt.GetSpends()) {
        strStats += tr("zCH Spend #: ") + QString::number(nCount) + ", ";
                               ...
                               const CAmount& watchImmatureBalance)
{
    ...
    for (const auto& denom : libzerocoin::zerocoinDenomList) {
        ...
        strDenomStats = strUnconfirmed + QString::number(mapDenomBalances.at(denom)) + " x " +
                        ...
                        QString::number(nSumPerCoin) + " zCH </b>";
    ...
    ui->labelzAvailableAmount->setText(QString::number(zerocoinBalance/COIN) + QString(" zCH "));
    ui->labelzAvailableAmount_2->setText(QString::number(zerocoinBalance/COIN) + QString(" zCH "));
